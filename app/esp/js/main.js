...
function task1() {
	switch(R(1,6)) { 
		...
		case 6:
			var a = [
				["Личное местоимение <b>1</b> лица <b>ед.</b> числа <b>муж.</b> рода","yo"],
				["Личное местоимение <b>1</b> лица <b>ед.</b> числа <b>жен.</b> рода","yo"],
				["Личное местоимение <b>1</b> лица <b>мн.</b> числа <b>муж.</b> рода","nosotros"],
				["Личное местоимение <b>1</b> лица <b>мн.</b> числа <b>жен.</b> рода","nosotras"],																										
				["Личное местоимение <b>2</b> лица <b>ед.</b> числа <b>муж.</b> рода","tú"],
				["Личное местоимение <b>2</b> лица <b>ед.</b> числа <b>жен.</b> рода","tú"],
				["Личное местоимение <b>2</b> лица <b>мн.</b> числа <b>муж.</b> рода","vosotros"],
				["Личное местоимение <b>2</b> лица <b>мн.</b> числа <b>жен.</b> рода","vosotras"],
				["Личное местоимение <b>3</b> лица <b>ед.</b> числа <b>муж.</b> рода","él"],
				["Личное местоимение <b>3</b> лица <b>ед.</b> числа <b>жен.</b> рода","ella"],
				["Личное местоимение <b>3</b> лица <b>мн.</b> числа <b>муж.</b> рода","ellos"],
				["Личное местоимение <b>3</b> лица <b>мн.</b> числа <b>жен.</b> рода","ellas"],
				["Как вежливо обратиться к женщине? (Личное местоимение)","usted"],
				["Как вежливо обратиться к мужчине? (Личное местоимение)","usted"],
				["Как вежливо обратиться к группе женщин? (Личное местоимение)","ustedes"],
				["Как вежливо обратиться к группе мужчин? (Личное местоимение)","ustedes"],
			];
			var r = R(0,a.length-1);
			var C1 = a[r][3];
			setTask(a[r][0],"Напиши сюда",a[r][1],"см. местоимения");
			break;
	}
}
